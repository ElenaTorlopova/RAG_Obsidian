...
GRAPH_PROMPT = PromptTemplate(
    ...
    template="""Du bist ein hilfreicher Assistent mit Zugang zu einem Wissensgraphen.
Beantworte die Frage direkt in natürlicher Sprache. Schreibe NUR Fließtext als Antwort.
Rufe keine Funktionen auf, gib keinen Code zurück, verwende keine JSON- oder Python-Syntax.
